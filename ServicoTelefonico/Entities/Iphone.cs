...
namespace ServicoTelefonico.Entities
{
    public class Iphone : Smartphone
    {
        ...
        public static void AdicionarTelefone()
        {
            ...
            {
                Iphone iphone = new(numero, modelo, imei, memoria);
                List<Iphone> iphones = [iphone];
                Console.WriteLine($"{iphone.Modelo}, foi adicionado com sucesso");
            }
            else
            {
        ...
        public static void MostrarTelefones()
        {
            ...
            {
                if (!string.IsNullOrEmpty(iphone.Numero))
                {
                    Console.WriteLine($"{i} - {iphone.Modelo}");
                    i++;
                }
            }
